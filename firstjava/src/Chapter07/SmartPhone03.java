...
public class SmartPhone03 extends Phone {

	String model;
	
	SmartPhone03(String phoneNumber, String model) {
		super(phoneNumber);
		this.model = model;
	}
	...
	public static void main(String[] args) {
		...
		Phone phone = new SmartPhone03("010-1111-1111", "IOS");
		Phone phone2 = new SmartPhone02("010-2222-2222", "android");
