...
public class BoardRepositoryTest {
    ...
    public void findIdTest() {
        ...
        // view 페이지, edit form
        Optional<Board> result = boardRepository.findById(210);

        Board board = result.get();

        log.info("210번 게시물 >>>>>>> " + board);
    ...
    public void deleteTest() {
        ...
        int result = boardRepository.deleteByBno(210);
        log.info("결과 >>>>>>>> " + result);
    ...
    public void listTest() {
        ...
        log.info("전체 페이지 개수 >>>>>>>> " + totalCnt);

        // 게시물 리스트
        for(Board board : page.getContent()) {

            log.info("게시물 리스트 >>>>>>>> " + board);
        }
